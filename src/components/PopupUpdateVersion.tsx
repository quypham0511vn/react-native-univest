...
const PopupUpdateVersion = forwardRef<PopupActions, PopupProps>(
                ...
                <View style={styles.popup}>
                    ...
                    {showBtn && <View style={styles.wrapButton}>
                        <Touchable onPress={_onClose} style={styles.cancelButton}>
                            <Text style={styles.txtCancel}>{Languages.common.skip.toUpperCase()}</Text>
                        </Touchable>
                        <Touchable onPress={_onConfirm} style={styles.confirmButton}>
                            <Text style={styles.txtVerify}>{Languages.update.update.toUpperCase()}</Text>
                        </Touchable>
                    </View>}
                </View>
            </Modal>
