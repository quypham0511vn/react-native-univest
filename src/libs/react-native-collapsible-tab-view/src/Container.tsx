...
export const Container = React.memo(
    React.forwardRef<CollapsibleRef, CollapsibleProps>(
        (
            ...
            const _onHeaderHeightChanged = React.useCallback(
                (delta: any, headerHeight: any) => {
                    onHeaderHeightChanged?.(delta, headerHeight)
                },[]
            )
            ...
            const headerTranslateY = useDerivedValue(() => {
                ...
                const headerHeight = headerScrollDistance.value;
                const delta = Math.min(scrollYCurrent.value, headerHeight);

                runOnJS(_onHeaderHeightChanged)(
                    delta, headerHeight
                );
