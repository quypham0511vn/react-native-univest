...
public class FingerprintDialog extends DialogFragment implements FingerprintHandler.Callback {
    ...
    private String cancelTextManyTime = "";
    private String sensorDescription = "";
    private String sensorErrorDescription = "";
    private String errorText = "";
    private int lastErrorCode = FingerprintAuthConstants.AUTHENTICATION_FAILED;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFingerprintDescription.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        this.mFingerprintError.setTextColor(this.imageErrorColor);

        this.mCancelButton = (TextView) v.findViewById(R.id.cancel_button);
        this.mCancelButton.setText(this.cancelText);
        this.mCancelButton.setTextColor(this.imageErrorColor);
    ...
    public void setAuthConfig(final ReadableMap config) {
        ...
        if (config.hasKey("cancelTextManyTime")) {
            this.cancelTextManyTime = config.getString("cancelTextManyTime");
        }
    ...
    public void onError(String errorString, int errorCode) {
        ...
        if(errorCode == 7){
            this.mCancelButton.setText(this.cancelTextManyTime);
            this.mFingerprintError.setText(this.sensorErrorDescription);
        }else{
            this.mFingerprintError.setText(this.sensorDescription);
            this.mCancelButton.setText(this.cancelText);
        }
    }
    ...
    public void onCancelled() {
        this.isAuthInProgress = false;
        this.mFingerprintHandler.endAuth();
        this.dialogCallback.onCancelled(lastErrorCode);
        dismiss();
    }
}
